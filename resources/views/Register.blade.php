...
<body class="bg-gradient-to-br from-blue-600 via-purple-700 to-orange-500 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-xl rounded-3xl w-full max-w-md p-8 relative border border-orange-200">
        <div class="text-center mb-6">
            <img src="https://i.pinimg.com/736x/d4/a5/f8/d4a5f84467c521716e0b4eaef26fb836.jpg"  alt="logo dream cat" class="mx-auto w-20 h-20 mb-2">
            <h1 class="text-3xl font-bold text-orange-700">Daftar Zalada</h1>
        ...
        <p class="text-center text-sm text-gray-600 mt-4">
            Sudah punya akun?
            <a href="{{ route('login.form') }}" class="text-orange-600 hover:underline font-medium">Masuk di sini</a>
        </p>
    </div>
